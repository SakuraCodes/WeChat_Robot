...
if __name__ == '__main__':
    ...
    def PushActivity():
        wx = WeChat()
        msg_list = [
            '🎉【中秋活动挑战赛】🎁\n• 🔥参与吃货挑战，30天累计10单赢9.9元红包🧧\n• 参与迎中秋限定干饭挑战，7天累计18单赢24元红包🧧\n• 老用户参与中秋回归活动累计2单，送7天会员奖励🎁\n• ⏰中秋假期购买会员并且累计2单，赢13元红包🧧\n👉活动入口：打开app--点击赚钱--点击活动二海报，即可参与挑战赛'
            # '🎉活动一览表，🎁福利快速浏览\n\n1️⃣🎉【活动挑战赛】\n• 🔥参与吃货挑战，30天累计10单赢9.9元红包🧧\n• 参与迎中秋限定干饭挑战，7天累计18单赢24元红包🧧\n• 老用户参与中秋回归活动累计2单，送7天会员奖励🎁\n• ⏰活动预告：中秋假期购买会员并且累计2单，赢13元红包🧧\n👉活动入口：打开app--点击赚钱--点击活动二海报，即可参与挑战赛\n\n2️⃣🔥【吃霸王餐抽iPad】\n• 上线参与0元许愿，都能获得1天会员，人人有份，不容错过！\n• 参与吃霸王餐活动即有机会抽取iPad、拍立得、年会员、万元红包等开学礼包！\n🔗 活动详情入口：sourl.cn/PGDZa2 即可查看更多活动详情和参与方式'
            # '嘿！到点了别忘了点外卖\n💻工作再多 干饭要紧\n————՞•・•՞————\n📣中秋大促【到店专享】超划算💰\n①、麦当劳大饱口福三件套到手仅19.9元！\n\n②、瑞幸咖啡全网最低价10.49元！\n \n福利尽在歪麦霸王餐，速速囤卷吧❗\n👉6url.cn/C8XKHh'
        ]
        filepath = [
            r'C:\Users\MM\PycharmProjects\WeChat-Robot\pic\enter.jpg'
        ]
        PushMsg(msg_list, filepath)
